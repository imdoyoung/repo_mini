...
public class InMemberVo {
	
	// search
	private Integer shDelNy;
	private Integer shJobNy;
	private Integer shDiseaseNy;
	...
	public Integer getShJobNy() {
		return shJobNy;
	}
	public void setShJobNy(Integer shJobNy) {
		this.shJobNy = shJobNy;
	}
	public Integer getShDiseaseNy() {
		return shDiseaseNy;
	}
	public void setShDiseaseNy(Integer shDiseaseNy) {
		this.shDiseaseNy = shDiseaseNy;
	}
